...
class WgApiCore {
  ...
  function send($m = '', $p = array(), $pr = array()) {
    ...
    $d = curl_exec($c);
	var_dump($m, $p, $pr, $this->setURL($pr, $m), http_build_query($p), $d);
    curl_close($c);
...
//при ошибки переводим обработчик ошибок
  ...
  function update() {
    ...
    foreach ($knowledgeBase['methods'] as $method) {
      ...
      $functional .= "if (!\$this->validate(\$input, array(" . implode(", ", (array) @$input_fields['required']) . "), array(" . implode(", ", (array) @$input_fields['other']) . ")))\nreturn NULL;\n";
      unset($input_fields);
...
if (!$this->validate($input, array('application_id' => 'string'), array('language' => 'string', 'fields' => 'string', 'search' => 'string', 'limit' => 'numeric', 'order_by' => 'string', 'page_no' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'clan_id' => 'numeric, list'), array('language' => 'string', 'fields' => 'string', 'access_token' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'clan_id' => 'numeric, list'), array('language' => 'string', 'fields' => 'string', 'access_token' => 'string', 'map_id' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string'), array('language' => 'string', 'fields' => 'string', 'map_id' => 'string', 'time' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'clan_id' => 'numeric'), array('language' => 'string', 'fields' => 'string', 'access_token' => 'string')))
return NULL;
...
$this->erorr->add(array(array(407, "CLAN_ID_LIST_LIMIT_EXCEEDED", "Лимит переданных идентификаторов **clan_id** превышен ( >100 )")));
if (!$this->validate($input, array('application_id' => 'string', 'clan_id' => 'numeric, list'), array('language' => 'string', 'fields' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'clan_id' => 'numeric'), array('language' => 'string', 'fields' => 'string', 'map_id' => 'numeric', 'since' => 'timestamp/date', 'until' => 'timestamp/date', 'offset' => 'numeric', 'limit' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'member_id' => 'numeric, list'), array('language' => 'string', 'fields' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string'), array('language' => 'string', 'fields' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'account_id' => 'numeric, list', 'type' => 'string'), array('language' => 'string', 'fields' => 'string', 'date' => 'timestamp/date')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'account_id' => 'numeric', 'type' => 'string', 'rank_field' => 'string'), array('language' => 'string', 'fields' => 'string', 'date' => 'timestamp/date', 'limit' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'type' => 'string', 'rank_field' => 'string'), array('language' => 'string', 'fields' => 'string', 'date' => 'timestamp/date', 'limit' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'type' => 'string'), array('language' => 'string', 'fields' => 'string', 'account_id' => 'numeric, list')))
return NULL;
...
function lists ($input = array()) {
$this->erorr->add(array(array(402, "SEARCH_NOT_SPECIFIED", "Не указан обязательный параметр **search**"), array(407, "NOT_ENOUGH_SEARCH_LENGTH", "Недостаточная длина параметра **search**. Минимум 3 символа")));
if (!$this->validate($input, array('application_id' => 'string', 'search' => 'string'), array('language' => 'string', 'fields' => 'string', 'type' => 'string', 'limit' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'account_id' => 'numeric, list'), array('language' => 'string', 'fields' => 'string', 'access_token' => 'string')))
return NULL;
...
$this->erorr->add(array(array(407, "ACCOUNT_ID_LIST_LIMIT_EXCEEDED", "Лимит переданных идентификаторов **account_id** превышен ( >100 )")));
if (!$this->validate($input, array('application_id' => 'string', 'account_id' => 'numeric, list'), array('language' => 'string', 'fields' => 'string', 'access_token' => 'string', 'tank_id' => 'numeric, list')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'account_id' => 'numeric, list'), array('language' => 'string', 'fields' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'map_id' => 'string'), array('language' => 'string', 'fields' => 'string', 'limit' => 'numeric', 'page_no' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'map_id' => 'string', 'account_id' => 'numeric, list'), array('language' => 'string', 'fields' => 'string')))
return NULL;
 ...
 */
function provinces ($input = array()) {
if (!$this->validate($input, array('application_id' => 'string', 'map_id' => 'string'), array('language' => 'string', 'fields' => 'string', 'province_id' => 'string, list')))
return NULL;
 ...
 */
function top ($input = array()) {
if (!$this->validate($input, array('application_id' => 'string', 'map_id' => 'string', 'order_by' => 'string'), array('language' => 'string', 'fields' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'map_id' => 'string', 'province_id' => 'string'), array('language' => 'string', 'fields' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'map_id' => 'string', 'access_token' => 'string'), array('language' => 'string', 'fields' => 'string', 'since' => 'timestamp/date', 'until' => 'timestamp/date', 'page_no' => 'numeric', 'limit' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'map_id' => 'string'), array('language' => 'string', 'fields' => 'string', 'page_no' => 'numeric', 'limit' => 'numeric')))
return NULL;
 ...
 */
function battles ($input = array()) {
if (!$this->validate($input, array('application_id' => 'string', 'map_id' => 'string', 'clan_id' => 'numeric, list'), array('language' => 'string', 'fields' => 'string', 'access_token' => 'string')))
return NULL;
 ...
 */
function victorypointshistory ($input = array()) {
if (!$this->validate($input, array('application_id' => 'string', 'map_id' => 'string', 'clan_id' => 'numeric'), array('language' => 'string', 'fields' => 'string', 'since' => 'timestamp/date', 'until' => 'timestamp/date', 'offset' => 'numeric', 'limit' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string'), array('language' => 'string', 'expires_at' => 'numeric', 'redirect_uri' => 'string', 'display' => 'string', 'nofollow' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'access_token' => 'string'), array('language' => 'string', 'expires_at' => 'numeric')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'access_token' => 'string'), array('language' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'tank_id' => 'numeric, list'), array('language' => 'string', 'fields' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string'), array('language' => 'string', 'fields' => 'string', 'module_id' => 'numeric, list', 'nation' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string'), array('language' => 'string', 'fields' => 'string', 'module_id' => 'numeric, list', 'nation' => 'string', 'turret_id' => 'numeric', 'tank_id' => 'numeric')))
return NULL;
 ...
 */
function info ($input = array()) {
if (!$this->validate($input, array('application_id' => 'string'), array('language' => 'string')))
return NULL;
...
if (!$this->validate($input, array('application_id' => 'string', 'account_id' => 'numeric'), array('language' => 'string', 'fields' => 'string', 'access_token' => 'string', 'tank_id' => 'numeric, list', 'in_garage' => 'string')))
return NULL;
